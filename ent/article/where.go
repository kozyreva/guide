...
func Number(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func NumberEQ(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldNumber), v))
	})
}
...
func NumberNEQ(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func NumberIn(vs ...float64) predicate.Article {
...
func NumberNotIn(vs ...float64) predicate.Article {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NumberGT(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func NumberGTE(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func NumberLT(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func NumberLTE(v float64) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func HasSegments() predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
...
func HasSegmentsWith(preds ...predicate.Segment) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOwnerWith(preds ...predicate.Document) predicate.Article {
	return predicate.Article(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
