...
func ID(id int) predicate.Parameter {
...
func IDEQ(id int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
...
// HasFeaturedProducts applies the HasEdge predicate on the "featured_products" edge.
func HasFeaturedProducts() predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FeaturedProductsTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, FeaturedProductsTable, FeaturedProductsPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasFeaturedProductsWith applies the HasEdge predicate on the "featured_products" edge with a given conditions (other predicates).
func HasFeaturedProductsWith(preds ...predicate.Product) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(FeaturedProductsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, FeaturedProductsTable, FeaturedProductsPrimaryKey...),
		)
...
func HasFeatures() predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasFeaturesWith(preds ...predicate.Feature) predicate.Parameter {
	return predicate.Parameter(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
